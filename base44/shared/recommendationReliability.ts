...
export function hardenAnalysisResult(raw, audit, generatedAt = new Date().toISOString()) {
  ...
  const recommendations = (source.recommendations || []).map((rec) => {
