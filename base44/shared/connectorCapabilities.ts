export const CONNECTOR_CAPABILITIES = {
  ...
  stripe_billing: { application_discovery: false, users: false, seat_assignments: false, login_activity: false, deep_usage: false, spend: false, invoices: false, contracts: false, renewals: false, identity_activity: false }
};
