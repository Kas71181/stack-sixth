      ...
      <div className="bg-amber-50 border border-amber-200 rounded-xl p-3 space-y-1">
        ...
        <p className="text-[11px] text-amber-700">
          {connector.multiSecret
            ? "Set SALESFORCE_CLIENT_ID, SALESFORCE_CLIENT_SECRET, and SALESFORCE_INSTANCE_URL in Dashboard → Settings → Environment Variables."
            : `Set ${connector.secretKey} in Dashboard → Settings → Environment Variables.`}
        </p>
