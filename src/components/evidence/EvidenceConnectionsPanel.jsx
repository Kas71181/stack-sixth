      ...
      <div className="grid gap-3 lg:grid-cols-2">
        {data.map((connection) => (
          <div key={connection.id} className="glass-card p-5">
            ...
            <p className="mt-2 text-xs text-muted-foreground">Last sync: {connection.last_successful_sync_at ? new Date(connection.last_successful_sync_at).toLocaleDateString() : "No verified sync"}</p>
