...
import SavingsEvidenceList from "@/components/evidence/SavingsEvidenceList";
...
export default function EvidenceSavingsOverview() {
  ...
  const cards = [
    { label: "Ready to capture", value: data.summary.verifiedSavings == null ? "N/A" : `$${data.summary.verifiedSavings.toLocaleString()}/mo`, icon: BadgeDollarSign },
  ...
  return (
    <div className="space-y-5">
      ...
      <SavingsEvidenceList applications={data.applications} />
